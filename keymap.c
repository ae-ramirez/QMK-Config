...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[MEDIA_SYMB] = LAYOUT(KC_MUTE, KC_VOLD, KC_MSTP, KC_VOLU, KC_TRNS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_BSLS, KC_CIRC, KC_AMPR, KC_ASTR, KC_TRNS, KC_TILD, KC_BRID, KC_MSEL, KC_BRIU, KC_TRNS, KC_PIPE, KC_LT, KC_GT, KC_QUES, KC_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[MOUSE] = LAYOUT(KC_TRNS, KC_TRNS, KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN2, KC_WH_D, KC_BTN1, KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(5), KC_TRNS, KC_TRNS, KC_TRNS),
